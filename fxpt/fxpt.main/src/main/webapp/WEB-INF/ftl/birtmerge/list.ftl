...
<@breadcrumbs.breadcrumbs currentPath="合并脚本">
<!-- 表单内容-->
  <#assign buttons=[{"text":"合成脚本","trigger":"batchGrant"}] >
  <@userContentTop.contentTop title="合并脚本" buttons=buttons/>
  ...
  <@reportGrid.grid  headers=headers rows=rows hasNested=true
    buttons=optBtn pager=pager showPager=true hasFirstCheckbox=true showSeq=false idPreFix="birtmerge">
