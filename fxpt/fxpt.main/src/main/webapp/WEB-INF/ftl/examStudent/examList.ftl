...
<div class="page-content">
	...
	<!-- page-header -->
	<#assign
	btns=[{"text":"学生模板下载","id":"downloadTemplate","class":"btn-primary","closeBtn":false}]>
	<@pageHead.pageHead title="${title!'报名信息导入'}" buttons=btns/>
	<!-- /.page-header -->
	...
	<div class="form-group">
		...
		<label class="col-md-1 col-sm-1 control-label">导入学生</label>
		<div class="col-md-2 col-sm-2">
				<select class="form-control selectpicker myData" id="hasExamStudent"
					name="hasExamStudent">
	...
	<@table.table tableId="examList" head=["考试日期","考试名称","考试简称","信息状态","导入学生","操作"]>
