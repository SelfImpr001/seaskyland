<div class="row">
	<div class="col-md-${exam.wlForExamStudent?string("6","12")} uplingScoreTable">
		...
		<@table.table tableId="" head=["名称","名次","科目","操作"] css='editTable ${exam.wlForExamStudent?string("L","")}' wl='${exam.wlForExamStudent?string("1","0")}' scoreType=3 level=1>
			<@trL.tr name="name"  score = scoreData["jianzi"] zf = false></@trL.tr>
			<#list score_m['jianzi'].paramslsitL as us>
				<tr>
					<td class="col-sm-3">
					...
					<td class="col-sm-3">
						<input type="text" class="form-control showEdit" value="${us.divideScale!''}" name="${scoreData['jianzi']}">
						<label class="showValue"></label>
					</td>
	...
	<#if exam.wlForExamStudent>
		<div class="col-md-6 uplingScoreTable">
			...
			<@table.table tableId="" head=["名称","名次","科目","操作"] css="editTable W" wl='2' scoreType=3 level=1>
				<@trW.tr name="name"  score = scoreData["jianzi"] zf = false></@trW.tr>
				<#list score_m['jianzi'].paramslsitW as us>
					<tr>
						<td class="col-sm-3">
							<input type="text" class="form-control showEdit" value='${us.name}' name="name">
							<label class="showValue"></label>
