<div class="row">
	<div class="col-md-${exam.wlForExamStudent?string("6","12")} uplingScoreTable">
		...
		<@table.table tableId="" head=["名称","分数","科目","操作"] css='editTable ${exam.wlForExamStudent?string("L","")}' wl='${exam.wlForExamStudent?string("1","0")}' scoreType=scoreMap["youxiao"]>
			<@trL.tr name="name"  score = scoreData["youxiao"] zf = false ></@trL.tr>
			<#list score_m['youxiao'].paramslsitL as us>
				<tr>
					<td class="col-sm-3">
	...
	<#if exam.wlForExamStudent>
		<div class="col-md-6 uplingScoreTable">
			...
			<@table.table tableId="" head=["名称","分数","科目","操作"] css="editTable W" wl='2' scoreType=scoreMap["youxiao"]>
				<@trW.tr name="name"  score = scoreData["youxiao"] zf = false></@trW.tr>
				<#list score_m['youxiao'].paramslsitW as us>
					<tr>
						<td class="col-sm-3">
							<input type="text" class="form-control showEdit" value='${us.name}' name="name" >
							<label class="showValue"></label>
