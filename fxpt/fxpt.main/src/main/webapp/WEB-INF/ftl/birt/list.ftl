...
<@breadcrumbs.breadcrumbs currentPath="${title!'脚本管理'}">
<!-- 表单内容-->
  <#assign buttons=[{"text":"导入脚本","trigger":"create"}] >
  <@userContentTop.contentTop title="${title!'脚本管理'}" buttons=buttons/>
  ...
  <@reportGrid.grid  headers=headers rows=rows hasNested=true
    buttons=optBtn pager=pager showTree=true showPager=true hasFirstCheckbox=true showSeq=false idPreFix="user">
