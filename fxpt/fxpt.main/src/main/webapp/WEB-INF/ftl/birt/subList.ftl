...
<#list orgList![] as org>
	...
	<td><input name="myChecked" value="${org.pk!}" type="checkbox" class="ace"> <span class="lbl"></span> </td>
	 ...
	 <td>
	    <div class="btn-group">
	      <a href="javascript:void(0);" pk=${org.pk?c! ""}   trigger="permission">生成word</a>
	      <span class="separator">|</span>
	      <a href="javascript:void(0);" pk=${org.pk?c! ""}  trigger="download">下载word</a>
	      <span class="separator">|</span>
	      <a href="javascript:void(0);" pk=${org.pk?c! ""} trigger="update">修改脚本</a>  
	        <span class="separator">|</span>
...
<#if query??>
  ...
  <div >
	  <div style="text-align: center">
		...
		<div id="orgBirt_pager" class="pager" style="margin-top: 20px; text-align: center"></div>
	  </div>  
  </div>
</#if>