...
<div class="page-content">
  ...
  <ul class="nav nav-tabs">
    <li ><a href="javascript:void(0);">核对成功(${uc})</a></li>
    <li class="active"><a href="javascript:void(0);">核对不成功(${pager.totalRows!0})</a></li>
  </ul>
		...
		<table class="table table-bordered table-striped table-hover ">
			...
			<#list query.list as checked>
			  <tr>
			    ...
			    <td>${exam.examStudentJiebieName!""}</td>
