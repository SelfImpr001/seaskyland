...
import com.cntest.fxpt.anlaysis.calculate.impl.XinjiangCalcluator;
 ...
 * @version 1.0
 */
public class XinjiangCalculateHandler implements EventHandler<CalculateTask>,
		WorkHandler<CalculateTask> {
	private static final Logger log = LoggerFactory
			.getLogger(XinjiangCalculateHandler.class);

	@Override
	public void onEvent(CalculateTask event) throws Exception {
		try {
			XinjiangCalcluator calculator = new XinjiangCalcluator();
