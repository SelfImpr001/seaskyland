/*
 * @(#)com.cntest.fxpt.anlaysis.repository.IPersonalReportExamDao.java	1.0 2014年7月18日:下午5:03:15
 *
 ...
 * </Pre>
 * 
 * @author 黄洪成 2014年7月18日 下午5:03:15
 * @version 1.0
 */
public interface IPersonalReportExamDao {
	...
	public List<Object> getAllHissubjectSumScoreStdsProc(Long examId, int wl, String studentId,String schoolid);
