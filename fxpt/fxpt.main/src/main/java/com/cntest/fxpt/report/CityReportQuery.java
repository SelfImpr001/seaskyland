 ...
 * @version 1.0
 **/
public class CityReportQuery extends AbstractReportQuery {
	
	private static String queryName = "com.cntest.fxpt.report.CityReportQuery.reportFor";

	private static String countQueryName = "com.cntest.fxpt.report.CityReportQuery.reportFor.count";
