 ...
 * @version 1.0
 **/
public class ProviceReportQuery extends AbstractReportQuery {

	private static String queryName = "com.cntest.fxpt.report.ProviceReportQuery.reportFor";
	
	private static String countQueryName = "com.cntest.fxpt.report.ProviceReportQuery.reportFor.count";
